...
mousemodel=2				# MODIFY TO SELECT WHICH VOLCANO PLOT IS TO BE MADE
...
if splashcheck==1:
	...
	supersplashdf.to_csv('Ultimate_SPLASH_IS.csv', index=False)
	print('Data for Ultimate SPLASH ONE internal standards is written in file. To run workflow, set splashcheck=0 in line 253.')
	quit()
...
outfilename=today+'SKYLITE_3_quantities_for_SKYLITE_4_neg.xlsx'
wb.save(outfilename)
