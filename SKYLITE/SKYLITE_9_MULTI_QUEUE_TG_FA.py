...
print('SKYLITE multi analysis is starting now...')

analyseall=0			# switch to either run full analysis or skip and proceed to merge existing results
if analyseall==1:
	repi=0
