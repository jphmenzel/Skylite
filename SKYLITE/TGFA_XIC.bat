...
set SKYLINE_RUNNER="%ROOT_ANALYSIS_DIR%\OxLPD1_black_box\SKYLITE\SkylineRunner.exe"
set BAT_Script_TGFA_XIC_run="%ROOT_ANALYSIS_DIR%\OxLPD1_black_box\SKYLITE\TGFA_XIC_run.bat"
set LOG="%ROOT_ANALYSIS_DIR%\OxLPD1_black_box\SKYLITE\workflow_log_files\Import.log"
FOR /F %%A IN ('WMIC OS GET LocalDateTime ^| FINDSTR \.') DO @SET DT=%%A
set LOG_ROLLOVER="%ROOT_ANALYSIS_DIR%\OxLPD1_black_box\SKYLITE\workflow_log_files\Import_%DT:~0,8%_%DT:~8,6%.log"
...
call %BAT_Script_TGFA_XIC_run% SKYLITE_multi_results %dataset% %replicate% 100000 12 "template.sky"
