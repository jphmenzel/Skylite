...
rem echo batch2 starts

set BASE_NAME=%1
set DATA_DIR=%2
set MODEL_NAMEx=%3
set MODEL_NAME=%MODEL_NAMEx:~0,-1%
rem %3
set FILTER_RES=%4
set FILTER_TIME=%5
set SKYLINE_FILE=%6
...
%SKYLINE_RUNNER% --timestamp --dir="%ROOT_DIR%" --in="..\%SKYLINE_FILE%" --out="%MODEL_NAME%\SKYLITE_TGFA_characteristic_pattern_pos.sky" --overwrite >> %LOG%
...
"python.exe" "%~dp0\SKYLITE_8_TG_FA_XIC_analysis_pos.py" %MODEL_NAMEx%
